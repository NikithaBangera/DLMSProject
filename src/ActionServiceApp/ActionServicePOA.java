 ...
 implements ActionServiceApp.ActionServiceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("validateUser", new java.lang.Integer (7));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 7:  // ActionServiceApp/ActionService/validateUser
       {
         String userID = in.read_string ();
         boolean $result = false;
         $result = this.validateUser (userID);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }

       case 8:  // ActionServiceApp/ActionService/exchangeItem
       {
         String userID = in.read_string ();
